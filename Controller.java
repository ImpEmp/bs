...
public class Controller {
	...
	private static final Class<?>[] playerClasses = {// the set of players
		...
		CalculatingLiar.class, Player2.class, HumanPlayer3.class,Drunkard.class/****Jerk.class,TwoCardPlayer.class, *****/Player4.class, PlayerConMan.class,SawyerPowel.class
	};
